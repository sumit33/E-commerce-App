...
public class BestOffersAdapter extends RecyclerView.Adapter<BestOffersAdapter.ViewHolder>{
    ...
    private ArrayList<BestItemReciever> mlist;
    ...
    public BestOffersAdapter(Context context, ArrayList<BestItemReciever> list) {
        mContext = context;
        mlist = list;
    }
    ...
    public BestItemReciever getValueAt(int position) {
